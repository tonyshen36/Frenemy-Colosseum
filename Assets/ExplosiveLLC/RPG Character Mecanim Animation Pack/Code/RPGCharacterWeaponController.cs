...
namespace RPGCharacterAnims
{
    public class RPGCharacterWeaponController : MonoBehaviour
    {
		...
		public WeaponTrigger leftHand;
		public WeaponTrigger rightHand;
		public WeaponTrigger leftFoot;
		public WeaponTrigger rightFoot;

		private WeaponTrigger twoHandAxeTrigger;
		private WeaponTrigger twoHandSwordTrigger;
		public WeaponTrigger twoHandSpearTrigger;
		private WeaponTrigger twoHandBowTrigger;
		private WeaponTrigger twoHandCrossbowTrigger;
		private WeaponTrigger staffTrigger;
		private WeaponTrigger swordLTrigger;
		private WeaponTrigger swordRTrigger;
		private WeaponTrigger maceLTrigger;
		private WeaponTrigger maceRTrigger;
		private WeaponTrigger daggerLTrigger;
		private WeaponTrigger daggerRTrigger;
		private WeaponTrigger itemLTrigger;
		private WeaponTrigger itemRTrigger;
		public WeaponTrigger shieldTrigger;
		private WeaponTrigger pistolLTrigger;
		private WeaponTrigger pistolRTrigger;
		private WeaponTrigger rifleTrigger;
		private WeaponTrigger spearTrigger;
        ...
        private void Awake()
        {
			...
			twoHandAxeTrigger = twoHandAxe.GetComponent<WeaponTrigger>();
			twoHandSwordTrigger = twoHandSword.GetComponent<WeaponTrigger>();
			//twoHandSpearTrigger = twoHandSpear.GetComponent<WeaponTrigger>();
			twoHandBowTrigger = twoHandBow.GetComponent<WeaponTrigger>();
			twoHandCrossbowTrigger = twoHandCrossbow.GetComponent<WeaponTrigger>();
			staffTrigger = staff.GetComponent<WeaponTrigger>();
			swordLTrigger = swordL.GetComponent<WeaponTrigger>();
			swordRTrigger = swordR.GetComponent<WeaponTrigger>();
			maceLTrigger = maceL.GetComponent<WeaponTrigger>();
			maceRTrigger = maceR.GetComponent<WeaponTrigger>();
			daggerLTrigger = daggerL.GetComponent<WeaponTrigger>();
			daggerRTrigger = daggerR.GetComponent<WeaponTrigger>();
			itemLTrigger = itemL.GetComponent<WeaponTrigger>();
			itemRTrigger = itemR.GetComponent<WeaponTrigger>();
			//shieldTrigger = shield.GetComponent<WeaponTrigger>();
			pistolLTrigger = pistolL.GetComponent<WeaponTrigger>();
			pistolRTrigger = pistolR.GetComponent<WeaponTrigger>();
			rifleTrigger = rifle.GetComponent<WeaponTrigger>();
			spearTrigger = spear.GetComponent<WeaponTrigger>();
			/*
			twoHandAxeTrigger.damage = 18.0f;
			twoHandSwordTrigger.damage = 22.0f;
			twoHandSpearTrigger.damage = 18.0f;
			twoHandBowTrigger.damage = 20.0f;
			twoHandCrossbowTrigger.damage = 20.0f;
			staffTrigger.damage = 20.0f;
			swordLTrigger.damage = 8.0f;
			swordRTrigger.damage = 10.0f;
			maceLTrigger.damage = 20.0f;
			maceRTrigger.damage = 20.0f;
			daggerLTrigger.damage = 10.0f;
			daggerRTrigger.damage = 10.0f;
			itemLTrigger.damage = 20.0f;
			itemRTrigger.damage = 20.0f;
			shieldTrigger.damage = 20.0f;
			pistolLTrigger.damage = 20.0f;
			pistolRTrigger.damage = 20.0f;
			rifleTrigger.damage = 20.0f;
			spearTrigger.damage = 20.0f;
			*/
		}
        ...
        private IEnumerator _UnSheathWeapon(Weapon weapon)
        {
            ...
            // Switching to 2Handed weapon.
				...
				if (currentWeaponType.Is2HandedWeapon()) {
                    ...
                    DoWeaponSwitch(( int )AnimatorWeapon.RELAX, weapon, weapon.ToAnimatorWeapon(), Side.Unchanged, false);
		...
		public void SetAllWeaponToUnattacked()
		{
			twoHandAxeTrigger.ClearTargetDamagedThisAttack();
			twoHandSwordTrigger.ClearTargetDamagedThisAttack();
			twoHandSpearTrigger.ClearTargetDamagedThisAttack();
			twoHandBowTrigger.ClearTargetDamagedThisAttack();
			twoHandCrossbowTrigger.ClearTargetDamagedThisAttack();
			staffTrigger.ClearTargetDamagedThisAttack();
			swordLTrigger.ClearTargetDamagedThisAttack();
			swordRTrigger.ClearTargetDamagedThisAttack();
			maceLTrigger.ClearTargetDamagedThisAttack();
			maceRTrigger.ClearTargetDamagedThisAttack();
			daggerLTrigger.ClearTargetDamagedThisAttack();
			daggerRTrigger.ClearTargetDamagedThisAttack();
			itemLTrigger.ClearTargetDamagedThisAttack();
			itemRTrigger.ClearTargetDamagedThisAttack();
			shieldTrigger.ClearTargetDamagedThisAttack();
			pistolLTrigger.ClearTargetDamagedThisAttack();
			pistolRTrigger.ClearTargetDamagedThisAttack();
			rifleTrigger.ClearTargetDamagedThisAttack();
			spearTrigger.ClearTargetDamagedThisAttack();
			leftFoot.ClearTargetDamagedThisAttack();
			rightFoot.ClearTargetDamagedThisAttack();
		}

		public WeaponTrigger GetWeaponTrigger(Weapon weapon)
        {
			switch (weapon)
			{
				case Weapon.TwoHandAxe: return twoHandAxeTrigger;
				case Weapon.TwoHandSword: return twoHandSwordTrigger;
				case Weapon.TwoHandSpear: return twoHandSpearTrigger;
				case Weapon.TwoHandBow: return twoHandBowTrigger;
				case Weapon.TwoHandCrossbow: return twoHandCrossbowTrigger;
				case Weapon.TwoHandStaff: return staffTrigger;
				case Weapon.LeftSword: return swordLTrigger;
				case Weapon.RightSword: return swordRTrigger;
				case Weapon.LeftMace: return maceLTrigger;
				case Weapon.RightMace: return maceRTrigger;
				case Weapon.LeftDagger: return daggerLTrigger;
				case Weapon.RightDagger: return daggerRTrigger;
				case Weapon.LeftItem: return itemLTrigger;
				case Weapon.RightItem: return itemRTrigger;
				case Weapon.Shield: return shieldTrigger;
				case Weapon.LeftPistol: return pistolLTrigger;
				case Weapon.RightPistol: return pistolRTrigger;
				case Weapon.Rifle: return rifleTrigger;
				case Weapon.RightSpear: return spearTrigger;
				case Weapon.Relax: return null;
				case Weapon.LeftFoot: return leftFoot;
				case Weapon.RightFoot: return rightFoot;
				default: return null;
			}
		}
		/*
		public void DisableAllWeaponTriggers()
		{
			twoHandAxeTrigger.triggerEnabled = false;
			twoHandSwordTrigger.triggerEnabled = false;
			twoHandSpearTrigger.triggerEnabled = false;
			twoHandBowTrigger.triggerEnabled = false;
			twoHandCrossbowTrigger.triggerEnabled = false;
			staffTrigger.triggerEnabled = false;
			swordLTrigger.triggerEnabled = false;
			swordRTrigger.triggerEnabled = false;
			maceLTrigger.triggerEnabled = false;
			maceRTrigger.triggerEnabled = false;
			daggerLTrigger.triggerEnabled = false;
			daggerRTrigger.triggerEnabled = false;
			itemLTrigger.triggerEnabled = false;
			itemRTrigger.triggerEnabled = false;
			shieldTrigger.triggerEnabled = false;
			pistolLTrigger.triggerEnabled = false;
			pistolRTrigger.triggerEnabled = false;
			rifleTrigger.triggerEnabled = false;
			spearTrigger.triggerEnabled = false;
		}

		public void EnableAllWeaponTriggers()
		{
			twoHandAxeTrigger.triggerEnabled = true;
			twoHandSwordTrigger.triggerEnabled = true;
			twoHandSpearTrigger.triggerEnabled = true;
			twoHandBowTrigger.triggerEnabled = true;
			twoHandCrossbowTrigger.triggerEnabled = true;
			staffTrigger.triggerEnabled = true;
			swordLTrigger.triggerEnabled = true;
			swordRTrigger.triggerEnabled = true;
			maceLTrigger.triggerEnabled = true;
			maceRTrigger.triggerEnabled = true;
			daggerLTrigger.triggerEnabled = true;
			daggerRTrigger.triggerEnabled = true;
			itemLTrigger.triggerEnabled = true;
			itemRTrigger.triggerEnabled = true;
			shieldTrigger.triggerEnabled = true;
			pistolLTrigger.triggerEnabled = true;
			pistolRTrigger.triggerEnabled = true;
			rifleTrigger.triggerEnabled = true;
			spearTrigger.triggerEnabled = true;
		}
		*/
		public void SetAllWeaponSize(Vector3 sizeMultiplier)
        {
			twoHandAxe.transform.localScale = sizeMultiplier;
			twoHandSword.transform.localScale = sizeMultiplier;
			twoHandSpear.transform.localScale = sizeMultiplier;
			twoHandBow.transform.localScale = sizeMultiplier;
			twoHandCrossbow.transform.localScale = sizeMultiplier;
			staff.transform.localScale = sizeMultiplier;
			swordL.transform.localScale = sizeMultiplier;
			swordR.transform.localScale = sizeMultiplier;
			maceL.transform.localScale = sizeMultiplier;
			maceR.transform.localScale = sizeMultiplier;
			daggerL.transform.localScale = sizeMultiplier;
			daggerR.transform.localScale = sizeMultiplier;
			itemL.transform.localScale = sizeMultiplier;
			itemR.transform.localScale = sizeMultiplier;
			shield.transform.localScale = sizeMultiplier;
			pistolL.transform.localScale = sizeMultiplier;
			pistolR.transform.localScale = sizeMultiplier;
			rifle.transform.localScale = sizeMultiplier;
			spear.transform.localScale = sizeMultiplier;
		}
	}
}