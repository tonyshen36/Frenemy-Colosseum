...
namespace RPGCharacterAnims.Actions
{
    public class GetHit : MovementActionHandler<HitContext>
    {
        ...
        { return !controller.isRelaxed && !controller.isKnockback && !controller.isKnockdown && !controller.isSpecial /*&& !controller.isAttacking*/ && !controller.isBlocking && !controller.isDead; }
