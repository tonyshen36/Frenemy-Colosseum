...
namespace RPGCharacterAnims.Actions
{
	public class Attack:BaseActionHandler<AttackContext>
	{
		...
		{return !controller.isRelaxed && !active && !controller.isCasting && controller.canAction && !controller.isKnockback; }
		...
		protected override void _StartAction(RPGCharacterController controller, AttackContext context)
		{
			...
			duration = AnimationData.AttackDuration(attackSide, weaponNumber, attackNumber) / controller.attackAnimationSpeed;
