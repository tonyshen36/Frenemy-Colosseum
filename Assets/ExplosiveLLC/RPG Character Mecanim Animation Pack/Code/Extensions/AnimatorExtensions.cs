...
namespace RPGCharacterAnims.Extensions
{
    ...
    public static class AnimatorExtensions
    {
        ...
        public static void DebugAnimatorParameters(this Animator animator)
        {
			...
			Debug.Log("Stunned: " + animator.GetBool(AnimationParameters.Stunned));
			Debug.Log("Swimming: " + animator.GetBool(AnimationParameters.Swimming));
			Debug.Log("Blocking: " + animator.GetBool(AnimationParameters.Blocking));
			...
			Debug.Log("SheathLocation: " + animator.GetInteger(AnimationParameters.SheathLocation));
			Debug.Log("Talking: " + animator.GetInteger(AnimationParameters.Talking));
			...
			Debug.Log("AimHorizontal: " + animator.GetFloat(AnimationParameters.AimHorizontal));
			Debug.Log("AimVertical: " + animator.GetFloat(AnimationParameters.AimVertical));
			Debug.Log("BowPull: " + animator.GetFloat(AnimationParameters.BowPull));
			Debug.Log("Charge: " + animator.GetFloat(AnimationParameters.Charge));
		}
