...
namespace RPGCharacterAnims
{
    ...
    public class RPGCharacterController : MonoBehaviour
    {
        ...
        //This controls how fast the attack animation plays
        public float attackAnimationSpeed = 1.0f;

        protected RPGCharacterWeaponController weaponController = null;

        public bool idleThisFrame = false;
        ...
        private bool doAnimFC = false;
        public float animFC = 0;
        private void LateUpdate()
        {
            // Update Animator animation speed.
            animator.SetFloat(AnimationParameters.AnimationSpeed, animationSpeed);

            if (isAttacking) animator.SetFloat(AnimationParameters.AnimationSpeed, attackAnimationSpeed);
            // Headlook.
        ...
        public void Roll(RollType rollNumber)
        {
			...
			SetIKPause(0.75f);
            audioSource.PlayOneShot(rollAudio, 0.7f);
		}
        ...
        public void GetHit(int hitNumber)
        {
			...
			if (isBlocking) {
                ...
                //Lock(false, false, false, 0.1f, 0.4f);
                //SetIKPause(0.6f);
			}
		}
